                            ...
                            <div class="row category">
                                                                                ...
                                                                                <select class="form-control" name="category">
                                                                                    @foreach ($categories as $category)
                                                                                        @if(empty($category->sub_category))
                                                                                            <option @if($category_item->category == $category->category) selected @endif>{{ $category->category }}</option>
                                                                                        @endif
                                                                                    @endforeach
                                                                                </select>
                                                                            </div>
                                                            ...
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <a href="{{ route('delete_category_data') }}?category_id={{ $category_item->id }}">Yes</a>
                                ...
                                <div class="col-4 category">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form action="{{ route('category_main') }}" method="post" enctype="multipart/form-data">
                                                @csrf
                                                <div class="form-group">
                                                    <label>Select category</label>
                                                    <select class="form-control" name="category">
